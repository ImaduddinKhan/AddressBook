...
//    [ApiController]
//    public class AddressBookDefController : ControllerBase
//    {
//        public readonly IAddressBookRepository _AddressBookRepository;

//        public AddressBookDefController(IAddressBookRepository addressBookRepository)
//        {
...
//        {
//            return await _AddressBookRepository.GetAll();
//        }
...
//        {
//            var model = await _AddressBookRepository.GetById(id);
//            if (model == null)
//            {
//                NotFound();
//            }
