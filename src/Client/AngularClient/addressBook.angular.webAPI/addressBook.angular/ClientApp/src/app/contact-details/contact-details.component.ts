...
export class ContactDetailsComponent implements OnInit {
    ...
    this.service.getById(id)
      .subscribe({
        next: (data) => {
          ...
          this.currentContact.phoneNo = data.phoneNumber;
  ...
  updatePublished(status: boolean): void {
    const data = {
      ...
      phoneNumber: this.currentContact.phoneNo,
      addressType: this.currentContact.addressType
    };

    this.service.update(this.currentContact.id, data)
      .subscribe({
        next: (res) => {
          console.log(res);
        },
  ...
  updateTutorial(): void {
    ...
    this.service.update(this.currentContact.id, this.currentContact)
      .subscribe({
        next: (res) => {
          console.log(res);
        },
  ...
  deleteTutorial(): void {
    this.service.delete(this.currentContact.id)
      .subscribe({
        next: (res) => {
          console.log(res);
